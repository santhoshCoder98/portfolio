      ...
      <div ref={ref} className="relative w-[75%] mx-auto lg:w-[90%] md:w-full">
        ...
        <ul className="w-full flex flex-col items-start justify-between ml-4">
          ...
          <Details
            ...
            time="2016-2020"
            place="Sri Venkateswara College of Engineering, Sriperumbudur, India"
            info="Relevant courses included Programming and Data Structures - I and II, Object Oriented Analysis and Design, Web Programming, Big Data Analytics, Cloud Computing"
          />
          ...
          <Details
            ...
            time="2023"
            place="Coursera"
            info="Completed coursework in advanced topics such as Supervised Learning, Unsupervised Learning, and Reinforcement Learning."
          />
        </ul>
      </div>
    </div>
